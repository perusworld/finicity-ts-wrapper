 ...
 */
export function instanceOfCashFlowReportConstraintsOut(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CashFlowReportConstraintsOutFromJSON(json: any): CashFlowReportConstraintsOut {
    return CashFlowReportConstraintsOutFromJSONTyped(json, false);
}

export function CashFlowReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashFlowReportConstraintsOut {
...
export function CashFlowReportConstraintsOutToJSON(value?: CashFlowReportConstraintsOut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
