 ...
 */
export function instanceOfCategorization(value: object): boolean {
    let isInstance = true;
...
export function CategorizationFromJSON(json: any): Categorization {
    return CategorizationFromJSONTyped(json, false);
}

export function CategorizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Categorization {
    ...
    return {
        ...
        'bestRepresentation': !exists(json, 'bestRepresentation') ? undefined : json['bestRepresentation'],
    };
}

export function CategorizationToJSON(value?: Categorization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
