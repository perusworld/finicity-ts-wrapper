 ...
 */
export function instanceOfVOIReportConstraints(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOIReportConstraintsFromJSON(json: any): VOIReportConstraints {
    return VOIReportConstraintsFromJSONTyped(json, false);
}

export function VOIReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIReportConstraints {
...
export function VOIReportConstraintsToJSON(value?: VOIReportConstraints | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
