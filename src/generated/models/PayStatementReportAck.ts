...
import {
    ...
    PayStatementReportConstraintsFromJSONTyped,
    PayStatementReportConstraintsToJSON,
} from './PayStatementReportConstraints';
 ...
 */
export function instanceOfPayStatementReportAck(value: object): boolean {
    let isInstance = true;
...
export function PayStatementReportAckFromJSON(json: any): PayStatementReportAck {
    return PayStatementReportAckFromJSONTyped(json, false);
}

export function PayStatementReportAckFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayStatementReportAck {
    ...
    return {
        ...
        'constraints': PayStatementReportConstraintsFromJSON(json['constraints']),
    };
}

export function PayStatementReportAckToJSON(value?: PayStatementReportAck | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'constraints': PayStatementReportConstraintsToJSON(value.constraints),
    };
}
