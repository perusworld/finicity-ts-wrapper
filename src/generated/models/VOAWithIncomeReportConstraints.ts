 ...
 */
export function instanceOfVOAWithIncomeReportConstraints(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOAWithIncomeReportConstraintsFromJSON(json: any): VOAWithIncomeReportConstraints {
    return VOAWithIncomeReportConstraintsFromJSONTyped(json, false);
}

export function VOAWithIncomeReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAWithIncomeReportConstraints {
...
export function VOAWithIncomeReportConstraintsToJSON(value?: VOAWithIncomeReportConstraints | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
