 ...
 */
export function instanceOfVOAWithIncomeReportConstraintsOut(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOAWithIncomeReportConstraintsOutFromJSON(json: any): VOAWithIncomeReportConstraintsOut {
    return VOAWithIncomeReportConstraintsOutFromJSONTyped(json, false);
}

export function VOAWithIncomeReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAWithIncomeReportConstraintsOut {
...
export function VOAWithIncomeReportConstraintsOutToJSON(value?: VOAWithIncomeReportConstraintsOut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
