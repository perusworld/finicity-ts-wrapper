...
import {
    VOIReportConstraintsOutFromJSON,
    VOIReportConstraintsOutFromJSONTyped,
    VOIReportConstraintsOutToJSON,
} from './VOIReportConstraintsOut';
 ...
 */
export function instanceOfVOIReportAck(value: object): boolean {
    let isInstance = true;
...
export function VOIReportAckFromJSON(json: any): VOIReportAck {
    return VOIReportAckFromJSONTyped(json, false);
}

export function VOIReportAckFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIReportAck {
    ...
    return {
        ...
        'constraints': VOIReportConstraintsOutFromJSON(json['constraints']),
    };
}

export function VOIReportAckToJSON(value?: VOIReportAck | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'constraints': VOIReportConstraintsOutToJSON(value.constraints),
    };
}
