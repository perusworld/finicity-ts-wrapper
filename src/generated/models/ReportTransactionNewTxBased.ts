 ...
 */
export function instanceOfReportTransactionNewTxBased(value: object): boolean {
    let isInstance = true;
...
export function ReportTransactionNewTxBasedFromJSON(json: any): ReportTransactionNewTxBased {
    return ReportTransactionNewTxBasedFromJSONTyped(json, false);
}

export function ReportTransactionNewTxBasedFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportTransactionNewTxBased {
...
export function ReportTransactionNewTxBasedToJSON(value?: ReportTransactionNewTxBased | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
