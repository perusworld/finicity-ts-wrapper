 ...
 */
export function instanceOfVOAReportConstraintsOut(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOAReportConstraintsOutFromJSON(json: any): VOAReportConstraintsOut {
    return VOAReportConstraintsOutFromJSONTyped(json, false);
}

export function VOAReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAReportConstraintsOut {
...
export function VOAReportConstraintsOutToJSON(value?: VOAReportConstraintsOut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
