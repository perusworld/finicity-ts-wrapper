 ...
 */
export function instanceOfCashFlowReportConstraints(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CashFlowReportConstraintsFromJSON(json: any): CashFlowReportConstraints {
    return CashFlowReportConstraintsFromJSONTyped(json, false);
}

export function CashFlowReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashFlowReportConstraints {
...
export function CashFlowReportConstraintsToJSON(value?: CashFlowReportConstraints | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
