...
import {
    PaystubTxVerifyMonthlyIncomeRecordFromJSON,
    PaystubTxVerifyMonthlyIncomeRecordFromJSONTyped,
    PaystubTxVerifyMonthlyIncomeRecordToJSON,
} from './PaystubTxVerifyMonthlyIncomeRecord';
 ...
 */
export function instanceOfVOIEPaystubWithStatementPayStatement(value: object): boolean {
    let isInstance = true;
...
export function VOIEPaystubWithStatementPayStatementFromJSON(json: any): VOIEPaystubWithStatementPayStatement {
    return VOIEPaystubWithStatementPayStatementFromJSONTyped(json, false);
}

export function VOIEPaystubWithStatementPayStatementFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIEPaystubWithStatementPayStatement {
    ...
    return {
        ...
        'monthlyIncome': PaystubTxVerifyMonthlyIncomeRecordFromJSON(json['monthlyIncome']),
    };
}

export function VOIEPaystubWithStatementPayStatementToJSON(value?: VOIEPaystubWithStatementPayStatement | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'monthlyIncome': PaystubTxVerifyMonthlyIncomeRecordToJSON(value.monthlyIncome),
    };
}
