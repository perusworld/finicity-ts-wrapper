...
import {
    PayrollReportConstraintsOutFromJSON,
    PayrollReportConstraintsOutFromJSONTyped,
    PayrollReportConstraintsOutToJSON,
} from './PayrollReportConstraintsOut';
 ...
 */
export function instanceOfPayrollReportAck(value: object): boolean {
    let isInstance = true;
...
export function PayrollReportAckFromJSON(json: any): PayrollReportAck {
    return PayrollReportAckFromJSONTyped(json, false);
}

export function PayrollReportAckFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayrollReportAck {
    ...
    return {
        ...
        'constraints': PayrollReportConstraintsOutFromJSON(json['constraints']),
    };
}

export function PayrollReportAckToJSON(value?: PayrollReportAck | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'constraints': PayrollReportConstraintsOutToJSON(value.constraints),
    };
}
