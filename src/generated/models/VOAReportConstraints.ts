 ...
 */
export function instanceOfVOAReportConstraints(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOAReportConstraintsFromJSON(json: any): VOAReportConstraints {
    return VOAReportConstraintsFromJSONTyped(json, false);
}

export function VOAReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAReportConstraints {
...
export function VOAReportConstraintsToJSON(value?: VOAReportConstraints | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
