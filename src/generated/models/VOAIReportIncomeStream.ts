 ...
 */
export function instanceOfVOAIReportIncomeStream(value: object): boolean {
    let isInstance = true;
...
export function VOAIReportIncomeStreamFromJSON(json: any): VOAIReportIncomeStream {
    return VOAIReportIncomeStreamFromJSONTyped(json, false);
}

export function VOAIReportIncomeStreamFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAIReportIncomeStream {
...
export function VOAIReportIncomeStreamToJSON(value?: VOAIReportIncomeStream | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
