 ...
 */
export function instanceOfVOIEWithTXVerifyReportConstraints(value: object): boolean {
    let isInstance = true;
...
export function VOIEWithTXVerifyReportConstraintsFromJSON(json: any): VOIEWithTXVerifyReportConstraints {
    return VOIEWithTXVerifyReportConstraintsFromJSONTyped(json, false);
}

export function VOIEWithTXVerifyReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIEWithTXVerifyReportConstraints {
...
export function VOIEWithTXVerifyReportConstraintsToJSON(value?: VOIEWithTXVerifyReportConstraints | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
