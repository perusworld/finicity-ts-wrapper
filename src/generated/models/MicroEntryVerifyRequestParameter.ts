 ...
 */
export function instanceOfMicroEntryVerifyRequestParameter(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MicroEntryVerifyRequestParameterFromJSON(json: any): MicroEntryVerifyRequestParameter {
    return MicroEntryVerifyRequestParameterFromJSONTyped(json, false);
}

export function MicroEntryVerifyRequestParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): MicroEntryVerifyRequestParameter {
...
export function MicroEntryVerifyRequestParameterToJSON(value?: MicroEntryVerifyRequestParameter | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
