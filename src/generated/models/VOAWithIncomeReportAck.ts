...
import {
    VOAWithIncomeReportConstraintsOutFromJSON,
    VOAWithIncomeReportConstraintsOutFromJSONTyped,
    VOAWithIncomeReportConstraintsOutToJSON,
} from './VOAWithIncomeReportConstraintsOut';
 ...
 */
export function instanceOfVOAWithIncomeReportAck(value: object): boolean {
    let isInstance = true;
...
export function VOAWithIncomeReportAckFromJSON(json: any): VOAWithIncomeReportAck {
    return VOAWithIncomeReportAckFromJSONTyped(json, false);
}

export function VOAWithIncomeReportAckFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOAWithIncomeReportAck {
    ...
    return {
        ...
        'constraints': VOAWithIncomeReportConstraintsOutFromJSON(json['constraints']),
    };
}

export function VOAWithIncomeReportAckToJSON(value?: VOAWithIncomeReportAck | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'constraints': VOAWithIncomeReportConstraintsOutToJSON(value.constraints),
    };
}
