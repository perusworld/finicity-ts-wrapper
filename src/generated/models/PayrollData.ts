 ...
 */
export function instanceOfPayrollData(value: object): boolean {
    let isInstance = true;
...
export function PayrollDataFromJSON(json: any): PayrollData {
    return PayrollDataFromJSONTyped(json, false);
}

export function PayrollDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayrollData {
...
export function PayrollDataToJSON(value?: PayrollData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
