 ...
 */
export function instanceOfLiteConnectParameters(value: object): boolean {
    let isInstance = true;
...
export function LiteConnectParametersFromJSON(json: any): LiteConnectParameters {
    return LiteConnectParametersFromJSONTyped(json, false);
}

export function LiteConnectParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiteConnectParameters {
...
export function LiteConnectParametersToJSON(value?: LiteConnectParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
