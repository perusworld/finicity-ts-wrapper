 ...
 */
export function instanceOfConnectEmailParameters(value: object): boolean {
    let isInstance = true;
...
export function ConnectEmailParametersFromJSON(json: any): ConnectEmailParameters {
    return ConnectEmailParametersFromJSONTyped(json, false);
}

export function ConnectEmailParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectEmailParameters {
...
export function ConnectEmailParametersToJSON(value?: ConnectEmailParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
