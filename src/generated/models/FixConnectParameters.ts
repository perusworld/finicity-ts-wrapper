 ...
 */
export function instanceOfFixConnectParameters(value: object): boolean {
    let isInstance = true;
...
export function FixConnectParametersFromJSON(json: any): FixConnectParameters {
    return FixConnectParametersFromJSONTyped(json, false);
}

export function FixConnectParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): FixConnectParameters {
...
export function FixConnectParametersToJSON(value?: FixConnectParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
