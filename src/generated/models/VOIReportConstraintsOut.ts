 ...
 */
export function instanceOfVOIReportConstraintsOut(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VOIReportConstraintsOutFromJSON(json: any): VOIReportConstraintsOut {
    return VOIReportConstraintsOutFromJSONTyped(json, false);
}

export function VOIReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIReportConstraintsOut {
...
export function VOIReportConstraintsOutToJSON(value?: VOIReportConstraintsOut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
