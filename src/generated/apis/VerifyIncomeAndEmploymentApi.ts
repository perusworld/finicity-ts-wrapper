...
import {
    ...
    ErrorMessageToJSON,
    PayStatementReportAckFromJSON,
    PayStatementReportAckToJSON,
    PayStatementReportConstraintsFromJSON,
    PayStatementReportConstraintsToJSON,
    PayrollReportAckFromJSON,
    PayrollReportAckToJSON,
    PayrollReportConstraintsFromJSON,
    PayrollReportConstraintsToJSON,
    VOETransactionsReportAckFromJSON,
    VOETransactionsReportAckToJSON,
    VOETransactionsReportConstraintsFromJSON,
    VOETransactionsReportConstraintsToJSON,
    VOIEPaystubReportAckFromJSON,
    VOIEPaystubReportAckToJSON,
    VOIEPaystubWithTXVerifyReportAckFromJSON,
    VOIEPaystubWithTXVerifyReportAckToJSON,
    VOIEReportConstraintsFromJSON,
    VOIEReportConstraintsToJSON,
    VOIEWithTXVerifyReportConstraintsFromJSON,
    VOIEWithTXVerifyReportConstraintsToJSON,
    VOIReportAckFromJSON,
    VOIReportAckToJSON,
    VOIReportConstraintsFromJSON,
    VOIReportConstraintsToJSON,
} from '../models/index';
 ...
 * 
 */
export class VerifyIncomeAndEmploymentApi extends runtime.BaseAPI {
     ...
     */
    async generatePayStatementReportRaw(requestParameters: GeneratePayStatementReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PayStatementReportAck>> {
        ...
        const response = await this.request({
            ...
            body: PayStatementReportConstraintsToJSON(requestParameters.payStatementReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PayStatementReportAckFromJSON(jsonValue));
    }
     ...
     * Generate Pay Statement Report
     */
    async generatePayStatementReport(requestParameters: GeneratePayStatementReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PayStatementReportAck> {
        const response = await this.generatePayStatementReportRaw(requestParameters, initOverrides);
     ...
     */
    async generateVOEPayrollReportRaw(requestParameters: GenerateVOEPayrollReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PayrollReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PayrollReportConstraintsToJSON(requestParameters.payrollReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PayrollReportAckFromJSON(jsonValue));
    }
     ...
     * Generate VOE - Payroll Report
     */
    async generateVOEPayrollReport(requestParameters: GenerateVOEPayrollReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PayrollReportAck> {
        const response = await this.generateVOEPayrollReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async generateVOETransactionsReportRaw(requestParameters: GenerateVOETransactionsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VOETransactionsReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: VOETransactionsReportConstraintsToJSON(requestParameters.vOETransactionsReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => VOETransactionsReportAckFromJSON(jsonValue));
    }
     ...
     * Generate VOE - Transactions Report
     */
    async generateVOETransactionsReport(requestParameters: GenerateVOETransactionsReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VOETransactionsReportAck> {
        const response = await this.generateVOETransactionsReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async generateVOIEPaystubReportRaw(requestParameters: GenerateVOIEPaystubReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VOIEPaystubReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: VOIEReportConstraintsToJSON(requestParameters.vOIEReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => VOIEPaystubReportAckFromJSON(jsonValue));
    }
     ...
     * Generate VOIE - Paystub Report
     */
    async generateVOIEPaystubReport(requestParameters: GenerateVOIEPaystubReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VOIEPaystubReportAck> {
        const response = await this.generateVOIEPaystubReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async generateVOIEPaystubWithTXVerifyReportRaw(requestParameters: GenerateVOIEPaystubWithTXVerifyReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VOIEPaystubWithTXVerifyReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: VOIEWithTXVerifyReportConstraintsToJSON(requestParameters.vOIEWithTXVerifyReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => VOIEPaystubWithTXVerifyReportAckFromJSON(jsonValue));
    }
     ...
     * Generate VOIE - Paystub (with TXVerify) Report
     */
    async generateVOIEPaystubWithTXVerifyReport(requestParameters: GenerateVOIEPaystubWithTXVerifyReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VOIEPaystubWithTXVerifyReportAck> {
        const response = await this.generateVOIEPaystubWithTXVerifyReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Generate VOI Report
     */
    async generateVOIReportRaw(requestParameters: GenerateVOIReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VOIReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: VOIReportConstraintsToJSON(requestParameters.vOIReportConstraints),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => VOIReportAckFromJSON(jsonValue));
    }
     ...
     * Generate VOI Report
     */
    async generateVOIReport(requestParameters: GenerateVOIReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VOIReportAck> {
        const response = await this.generateVOIReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async refreshVOIEPayrollReportRaw(requestParameters: RefreshVOIEPayrollReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PayrollReportAck>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
     ...
     * Generate VOIE - Payroll Report
     */
    async refreshVOIEPayrollReport(requestParameters: RefreshVOIEPayrollReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PayrollReportAck> {
        const response = await this.refreshVOIEPayrollReportRaw(requestParameters, initOverrides);
        return await response.value();
    }
