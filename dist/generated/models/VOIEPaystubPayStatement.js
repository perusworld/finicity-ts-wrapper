...
exports.VOIEPaystubPayStatementToJSON = exports.VOIEPaystubPayStatementFromJSONTyped = exports.VOIEPaystubPayStatementFromJSON = exports.instanceOfVOIEPaystubPayStatement = void 0;
const runtime_1 = require("../runtime");
const DirectDeposit_1 = require("./DirectDeposit");
const Employee_1 = require("./Employee");
const Employer_1 = require("./Employer");
const PayStat_1 = require("./PayStat");
const PaystubMonthlyIncomeRecord_1 = require("./PaystubMonthlyIncomeRecord");
/**
 * Check if a given object implements the VOIEPaystubPayStatement interface.
 */
function instanceOfVOIEPaystubPayStatement(value) {
    let isInstance = true;
...
exports.instanceOfVOIEPaystubPayStatement = instanceOfVOIEPaystubPayStatement;
function VOIEPaystubPayStatementFromJSON(json) {
    return VOIEPaystubPayStatementFromJSONTyped(json, false);
}
exports.VOIEPaystubPayStatementFromJSON = VOIEPaystubPayStatementFromJSON;
function VOIEPaystubPayStatementFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'monthlyIncome': (0, PaystubMonthlyIncomeRecord_1.PaystubMonthlyIncomeRecordFromJSON)(json['monthlyIncome']),
    };
}
exports.VOIEPaystubPayStatementFromJSONTyped = VOIEPaystubPayStatementFromJSONTyped;
function VOIEPaystubPayStatementToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'monthlyIncome': (0, PaystubMonthlyIncomeRecord_1.PaystubMonthlyIncomeRecordToJSON)(value.monthlyIncome),
    };
}
exports.VOIEPaystubPayStatementToJSON = VOIEPaystubPayStatementToJSON;
//# sourceMappingURL=VOIEPaystubPayStatement.js.map