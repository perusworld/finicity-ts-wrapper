...
exports.VOIEPayrollReportToJSON = exports.VOIEPayrollReportFromJSONTyped = exports.VOIEPayrollReportFromJSON = exports.instanceOfVOIEPayrollReport = void 0;
 ...
 */
function instanceOfVOIEPayrollReport(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfVOIEPayrollReport = instanceOfVOIEPayrollReport;
function VOIEPayrollReportFromJSON(json) {
    return VOIEPayrollReportFromJSONTyped(json, false);
}
exports.VOIEPayrollReportFromJSON = VOIEPayrollReportFromJSON;
function VOIEPayrollReportFromJSONTyped(json, ignoreDiscriminator) {
...
exports.VOIEPayrollReportFromJSONTyped = VOIEPayrollReportFromJSONTyped;
function VOIEPayrollReportToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.VOIEPayrollReportToJSON = VOIEPayrollReportToJSON;
//# sourceMappingURL=VOIEPayrollReport.js.map