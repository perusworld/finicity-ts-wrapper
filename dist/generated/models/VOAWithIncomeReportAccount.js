...
exports.VOAWithIncomeReportAccountToJSON = exports.VOAWithIncomeReportAccountFromJSONTyped = exports.VOAWithIncomeReportAccountFromJSON = exports.instanceOfVOAWithIncomeReportAccount = void 0;
...
const VOAIReportIncomeStream_1 = require("./VOAIReportIncomeStream");
/**
 * Check if a given object implements the VOAWithIncomeReportAccount interface.
 */
function instanceOfVOAWithIncomeReportAccount(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfVOAWithIncomeReportAccount = instanceOfVOAWithIncomeReportAccount;
function VOAWithIncomeReportAccountFromJSON(json) {
    return VOAWithIncomeReportAccountFromJSONTyped(json, false);
}
exports.VOAWithIncomeReportAccountFromJSON = VOAWithIncomeReportAccountFromJSON;
function VOAWithIncomeReportAccountFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'incomeStreams': !(0, runtime_1.exists)(json, 'incomeStreams') ? undefined : (json['incomeStreams'].map(VOAIReportIncomeStream_1.VOAIReportIncomeStreamFromJSON)),
    };
}
exports.VOAWithIncomeReportAccountFromJSONTyped = VOAWithIncomeReportAccountFromJSONTyped;
function VOAWithIncomeReportAccountToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'incomeStreams': value.incomeStreams === undefined ? undefined : (value.incomeStreams.map(VOAIReportIncomeStream_1.VOAIReportIncomeStreamToJSON)),
    };
}
exports.VOAWithIncomeReportAccountToJSON = VOAWithIncomeReportAccountToJSON;
//# sourceMappingURL=VOAWithIncomeReportAccount.js.map