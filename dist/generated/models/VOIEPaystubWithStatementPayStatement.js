...
exports.VOIEPaystubWithStatementPayStatementToJSON = exports.VOIEPaystubWithStatementPayStatementFromJSONTyped = exports.VOIEPaystubWithStatementPayStatementFromJSON = exports.instanceOfVOIEPaystubWithStatementPayStatement = void 0;
const runtime_1 = require("../runtime");
const DirectDeposit_1 = require("./DirectDeposit");
const Employee_1 = require("./Employee");
const Employer_1 = require("./Employer");
const PayStat_1 = require("./PayStat");
const PaystubTxVerifyMonthlyIncomeRecord_1 = require("./PaystubTxVerifyMonthlyIncomeRecord");
/**
 * Check if a given object implements the VOIEPaystubWithStatementPayStatement interface.
 */
function instanceOfVOIEPaystubWithStatementPayStatement(value) {
    let isInstance = true;
...
exports.instanceOfVOIEPaystubWithStatementPayStatement = instanceOfVOIEPaystubWithStatementPayStatement;
function VOIEPaystubWithStatementPayStatementFromJSON(json) {
    return VOIEPaystubWithStatementPayStatementFromJSONTyped(json, false);
}
exports.VOIEPaystubWithStatementPayStatementFromJSON = VOIEPaystubWithStatementPayStatementFromJSON;
function VOIEPaystubWithStatementPayStatementFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'monthlyIncome': (0, PaystubTxVerifyMonthlyIncomeRecord_1.PaystubTxVerifyMonthlyIncomeRecordFromJSON)(json['monthlyIncome']),
    };
}
exports.VOIEPaystubWithStatementPayStatementFromJSONTyped = VOIEPaystubWithStatementPayStatementFromJSONTyped;
function VOIEPaystubWithStatementPayStatementToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'monthlyIncome': (0, PaystubTxVerifyMonthlyIncomeRecord_1.PaystubTxVerifyMonthlyIncomeRecordToJSON)(value.monthlyIncome),
    };
}
exports.VOIEPaystubWithStatementPayStatementToJSON = VOIEPaystubWithStatementPayStatementToJSON;
//# sourceMappingURL=VOIEPaystubWithStatementPayStatement.js.map