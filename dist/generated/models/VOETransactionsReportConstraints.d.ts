 ...
 */
export declare function instanceOfVOETransactionsReportConstraints(value: object): boolean;
export declare function VOETransactionsReportConstraintsFromJSON(json: any): VOETransactionsReportConstraints;
export declare function VOETransactionsReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOETransactionsReportConstraints;
export declare function VOETransactionsReportConstraintsToJSON(value?: VOETransactionsReportConstraints | null): any;
