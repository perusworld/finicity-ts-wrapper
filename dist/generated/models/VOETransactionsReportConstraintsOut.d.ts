 ...
 */
export declare function instanceOfVOETransactionsReportConstraintsOut(value: object): boolean;
export declare function VOETransactionsReportConstraintsOutFromJSON(json: any): VOETransactionsReportConstraintsOut;
export declare function VOETransactionsReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOETransactionsReportConstraintsOut;
export declare function VOETransactionsReportConstraintsOutToJSON(value?: VOETransactionsReportConstraintsOut | null): any;
