 ...
 */
export declare function instanceOfPayStatementForVoie(value: object): boolean;
export declare function PayStatementForVoieFromJSON(json: any): PayStatementForVoie;
export declare function PayStatementForVoieFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayStatementForVoie;
export declare function PayStatementForVoieToJSON(value?: PayStatementForVoie | null): any;
