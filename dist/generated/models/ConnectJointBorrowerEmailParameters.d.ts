 ...
 */
export declare function instanceOfConnectJointBorrowerEmailParameters(value: object): boolean;
export declare function ConnectJointBorrowerEmailParametersFromJSON(json: any): ConnectJointBorrowerEmailParameters;
export declare function ConnectJointBorrowerEmailParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectJointBorrowerEmailParameters;
export declare function ConnectJointBorrowerEmailParametersToJSON(value?: ConnectJointBorrowerEmailParameters | null): any;
