 ...
 */
export declare function instanceOfCreatedCustomer(value: object): boolean;
export declare function CreatedCustomerFromJSON(json: any): CreatedCustomer;
export declare function CreatedCustomerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatedCustomer;
export declare function CreatedCustomerToJSON(value?: CreatedCustomer | null): any;
