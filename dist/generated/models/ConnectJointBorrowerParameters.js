...
exports.ConnectJointBorrowerParametersToJSON = exports.ConnectJointBorrowerParametersFromJSONTyped = exports.ConnectJointBorrowerParametersFromJSON = exports.instanceOfConnectJointBorrowerParameters = void 0;
 ...
 */
function instanceOfConnectJointBorrowerParameters(value) {
    let isInstance = true;
    isInstance = isInstance && "partnerId" in value;
    isInstance = isInstance && "borrowers" in value;
    return isInstance;
}
exports.instanceOfConnectJointBorrowerParameters = instanceOfConnectJointBorrowerParameters;
function ConnectJointBorrowerParametersFromJSON(json) {
    return ConnectJointBorrowerParametersFromJSONTyped(json, false);
}
exports.ConnectJointBorrowerParametersFromJSON = ConnectJointBorrowerParametersFromJSON;
function ConnectJointBorrowerParametersFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ConnectJointBorrowerParametersFromJSONTyped = ConnectJointBorrowerParametersFromJSONTyped;
function ConnectJointBorrowerParametersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConnectJointBorrowerParametersToJSON = ConnectJointBorrowerParametersToJSON;
//# sourceMappingURL=ConnectJointBorrowerParameters.js.map