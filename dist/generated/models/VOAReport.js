...
exports.VOAReportToJSON = exports.VOAReportFromJSONTyped = exports.VOAReportFromJSON = exports.instanceOfVOAReport = void 0;
 ...
 */
function instanceOfVOAReport(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfVOAReport = instanceOfVOAReport;
function VOAReportFromJSON(json) {
    return VOAReportFromJSONTyped(json, false);
}
exports.VOAReportFromJSON = VOAReportFromJSON;
function VOAReportFromJSONTyped(json, ignoreDiscriminator) {
...
exports.VOAReportFromJSONTyped = VOAReportFromJSONTyped;
function VOAReportToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.VOAReportToJSON = VOAReportToJSON;
//# sourceMappingURL=VOAReport.js.map