 ...
 */
export declare function instanceOfVOIEWithTXVerifyReportConstraints(value: object): boolean;
export declare function VOIEWithTXVerifyReportConstraintsFromJSON(json: any): VOIEWithTXVerifyReportConstraints;
export declare function VOIEWithTXVerifyReportConstraintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIEWithTXVerifyReportConstraints;
export declare function VOIEWithTXVerifyReportConstraintsToJSON(value?: VOIEWithTXVerifyReportConstraints | null): any;
