 ...
 */
export declare function instanceOfVOIEWithTXVerifyReportConstraintsOut(value: object): boolean;
export declare function VOIEWithTXVerifyReportConstraintsOutFromJSON(json: any): VOIEWithTXVerifyReportConstraintsOut;
export declare function VOIEWithTXVerifyReportConstraintsOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): VOIEWithTXVerifyReportConstraintsOut;
export declare function VOIEWithTXVerifyReportConstraintsOutToJSON(value?: VOIEWithTXVerifyReportConstraintsOut | null): any;
