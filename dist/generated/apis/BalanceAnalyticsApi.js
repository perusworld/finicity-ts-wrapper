...
exports.BalanceAnalyticsApi = void 0;
const runtime = require("../runtime");
const index_1 = require("../models/index");
/**
 *
 */
class BalanceAnalyticsApi extends runtime.BaseAPI {
    /**
     ...
     */
    generateBalanceAnalyticsRaw(requestParameters, initOverrides) {
     ...
     * Generate Balance Analytics
     */
    generateBalanceAnalytics(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.generateBalanceAnalyticsRaw(requestParameters, initOverrides);
     ...
     */
    generateBalanceAnalyticsFcraRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
     ...
     * Generate Balance Analytics - FCRA
     */
    generateBalanceAnalyticsFcra(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.generateBalanceAnalyticsFcraRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
...
exports.BalanceAnalyticsApi = BalanceAnalyticsApi;
//# sourceMappingURL=BalanceAnalyticsApi.js.map